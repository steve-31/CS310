...
urlpatterns = [
    ...
    url(r'^project/restore/(?P<pid>[0-9]+)/(?P<exp>[0,1])/$', views.project_restore, name='project_restore'),
    url(r'^project/deploy/(?P<pid>[0-9]+)/$', views.project_deploy, name='project_deploy'),
    url(r'^project/deploy/link/(?P<vid>[0-9]+)/$', views.project_deploy_link, name='project_deploy_link'),
    url(r'^project/branch/(?P<pid>[0-9]+)/$', views.project_branch, name='project_branch'),
